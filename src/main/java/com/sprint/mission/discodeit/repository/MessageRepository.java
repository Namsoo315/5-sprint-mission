...
public interface MessageRepository extends JpaRepository<Message, UUID> {
  ...
  @Query("SELECT m FROM Message m JOIN FETCH m.author WHERE m.channel.id = :channelId AND m.createdAt > :cursor")
  ...
  Optional<Instant> findTopByChannelIdOrderByCreatedAtDesc(@Param("channelId") UUID channelId);
