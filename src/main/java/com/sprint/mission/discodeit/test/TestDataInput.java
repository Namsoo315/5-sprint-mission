...
public class TestDataInput {
	...
	public void testData() {
		...
		messageService.createMessage(
			new MessageCreateRequest(user1.getUserId(), publicChannel1.getChannelId(), "안녕하세요 유저1 -> 공용채널1"), dtos);
		messageService.createMessage(
			new MessageCreateRequest(user2.getUserId(), publicChannel2.getChannelId(), "안녕하세요 유저2 -> 공용채널2"), dtos);
		messageService.createMessage(
			new MessageCreateRequest(user1.getUserId(), privateChannel1.getChannelId(), "안녕하세요 유저1 -> 개인채널1"), dtos);
		messageService.createMessage(
			new MessageCreateRequest(user2.getUserId(), privateChannel1.getChannelId(), "안녕하세요 유저2 -> 개인채널1"), dtos);
		messageService.createMessage(
			new MessageCreateRequest(user3.getUserId(), privateChannel1.getChannelId(), "안녕하세요 유저3 -> 개인채널1"), dtos);
		messageService.createMessage(
			new MessageCreateRequest(user3.getUserId(), privateChannel2.getChannelId(), "안녕하세요 유저2 -> 개인채널2"), dtos);
		messageService.createMessage(
			new MessageCreateRequest(user3.getUserId(), privateChannel3.getChannelId(), "안녕하세요 유저3 -> 개인채널3"), dtos);
	}
}
